...
<body>
					...
					<table>
						<tr>
							...
							<td><input class="text" type="text" id="userName"
								name="user.userName" value="${user.userName }" /><span></span>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input class="text"
								...
								id="randImage" src="image.jsp" width="60" height="20" border="1"></td>
						</tr>
						<tr>
	...
	<div id="footer">
		Copyright &copy; 2015 热血传奇 All Rights Reserved. <a
			onclick="javascript:window.open('http://bdtg.37.com/s/1/1945/33922.html?uid=linuxidc.com&wd=0&ab_type=0&baidu_key=e0c257a18f9a7a14')"
			href="#">无锡人的传奇</a>
